...
import type { HistoryEntry, PaymentMethod } from "@/types/history"

const INITIAL_HISTORY: HistoryEntry[] = [
  { id: "1",  orderNumber: 142, clientName: "Ana Silva",       phone: "(11) 98765-4321", date: "Hoje",         type: "produto", discount: 0,  paymentMethod: "Pix",
    items: [ { name: "Fone de Ouvido Bluetooth", quantity: 1, total: 450.00 }, { name: "Caixa de Som Portátil", quantity: 1, total: 320.00 } ] },
  { id: "2",  orderNumber: 141, clientName: "Carlos Oliveira", phone: "(21) 99988-7766", date: "Hoje",         type: "produto", discount: 20, paymentMethod: "Cartão de Crédito",
    items: [ { name: "Câmera de Segurança 1080p", quantity: 1, total: 1250.00 } ] },
  { id: "3",  orderNumber: 140, clientName: "Mariana Pereira", phone: "(31) 97766-5544", date: "Hoje",         type: "produto", discount: 0,  paymentMethod: "Dinheiro",
    items: [ { name: "Luminária de Mesa LED", quantity: 2, total: 159.80 }, { name: "Garrafa Térmica 1L", quantity: 1, total: 59.90 } ] },
  { id: "4",  orderNumber: 139, clientName: "Rafael Ribeiro",  phone: "(41) 98855-2211", date: "Ontem",        type: "produto", discount: 0,  paymentMethod: "Pix",
    items: [ { name: "Relógio Inteligente", quantity: 1, total: 899.00 } ] },
  { id: "5",  orderNumber: 138, clientName: "Lucas Teixeira",  phone: "(51) 99123-4567", date: "Ontem",        type: "produto", discount: 15, paymentMethod: "Cartão de Débito",
    items: [ { name: "Cadeira Ergonômica", quantity: 1, total: 1450.00 } ] },
  { id: "6",  orderNumber: 137, clientName: "Fernanda Costa",  phone: "(11) 91234-5678", date: "Ontem",        type: "produto", discount: 0,  paymentMethod: "Pix",
    items: [ { name: "Teclado Mecânico RGB", quantity: 1, total: 399.00 }, { name: "Fone de Ouvido Bluetooth", quantity: 1, total: 450.00 } ] },
  { id: "7",  orderNumber: 136, clientName: "Bruno Mendes",    phone: "(31) 92233-4455", date: "17 Mar 2026",  type: "produto", discount: 0,  paymentMethod: "Cartão de Crédito",
    items: [ { name: "Caixa de Som Portátil", quantity: 2, total: 640.00 } ] },
  { id: "8",  orderNumber: 135, clientName: "Julia Santos",    phone: "(41) 93344-5566", date: "17 Mar 2026",  type: "produto", discount: 0,  paymentMethod: "Dinheiro",
    items: [ { name: "Luminária de Mesa LED", quantity: 1, total: 79.90 } ] },
  { id: "9",  orderNumber: 134, clientName: "Pedro Alves",     phone: "(51) 94455-6677", date: "17 Mar 2026",  type: "produto", discount: 30, paymentMethod: "Pix",
    items: [ { name: "Câmera de Segurança 1080p", quantity: 1, total: 1250.00 }, { name: "Relógio Inteligente", quantity: 1, total: 899.00 } ] },
  { id: "10", orderNumber: 133, clientName: "Camila Rocha",    phone: "(21) 95566-7788", date: "16 Mar 2026",  type: "produto", discount: 0,  paymentMethod: "Cartão de Débito",
    items: [ { name: "Garrafa Térmica 1L", quantity: 3, total: 179.70 } ] },
  { id: "11", orderNumber: 132, clientName: "Ana Silva",       phone: "(11) 98765-4321", date: "15 Mar 2026",  type: "produto", discount: 0,  paymentMethod: "Pix",
    items: [ { name: "Cadeira Ergonômica", quantity: 1, total: 1450.00 } ] },
  { id: "12", orderNumber: 131, clientName: "Carlos Oliveira", phone: "(21) 99988-7766", date: "10 Mar 2026",  type: "produto", discount: 0,  paymentMethod: "Dinheiro",
    items: [ { name: "Teclado Mecânico RGB", quantity: 1, total: 399.00 } ] },
  { id: "13", orderNumber: 209, clientName: "Ana Silva",       phone: "(11) 98765-4321", date: "Hoje",         type: "servico", discount: 0,  paymentMethod: "Pix",
    items: [ { name: "Manutenção de Ar Condicionado", quantity: 1, total: 280.00 } ] },
  { id: "14", orderNumber: 208, clientName: "Bruno Mendes",    phone: "(31) 92233-4455", date: "Ontem",        type: "servico", discount: 0,  paymentMethod: "Cartão de Crédito",
    items: [ { name: "Instalação Elétrica", quantity: 1, total: 350.00 } ] },
  { id: "15", orderNumber: 207, clientName: "Julia Santos",    phone: "(41) 93344-5566", date: "Ontem",        type: "servico", discount: 0,  paymentMethod: "Dinheiro",
    items: [ { name: "Conserto de Máquina de Lavar", quantity: 1, total: 190.00 } ] },
  { id: "16", orderNumber: 206, clientName: "Pedro Alves",     phone: "(51) 94455-6677", date: "17 Mar 2026",  type: "servico", discount: 10, paymentMethod: "Pix",
    items: [ { name: "Montagem de Móveis", quantity: 1, total: 220.00 } ] },
  { id: "17", orderNumber: 205, clientName: "Camila Rocha",    phone: "(21) 95566-7788", date: "16 Mar 2026",  type: "servico", discount: 0,  paymentMethod: "Cartão de Débito",
    items: [ { name: "Pintura Residencial", quantity: 1, total: 780.00 } ] },
  { id: "18", orderNumber: 204, clientName: "Fernanda Costa",  phone: "(11) 91234-5678", date: "15 Mar 2026",  type: "servico", discount: 0,  paymentMethod: "Pix",
...
export default function HistoricoPage() {
  ...
  const PaymentIcon = selectedEntry ? PAYMENT_ICONS[selectedEntry.paymentMethod] : QrCode
        ...
        {selectedEntry && (
          ...
          >
            ...
            <div className="flex w-80 flex-col gap-5 px-5 pb-5">
              ...
              <div className="flex flex-col items-center gap-2 border-t border-(--color-border) pt-4">
                <span className="text-[11px] font-semibold uppercase tracking-wide text-(--color-text-secondary)">
                  Forma de Pagamento
                </span>
