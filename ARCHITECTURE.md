...
| Sales-history records and export | Allowed | Hidden and denied |
...
Sales-history records are loaded from persisted sales with item and payment snapshots
embedded in the administrator response. Employees cannot access history records, KPIs,
or exports. CSV export is generated by
background jobs embedded in the API process and downloaded after the export job
completes.
